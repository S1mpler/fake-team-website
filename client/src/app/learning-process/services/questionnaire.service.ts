...
export class QuestionnaireService {
  ...
  private get questions(): QuestionAnswerModel[] {
    return [
      ...
      {
        id: 1,
        from: LearningMaterialType.PROS_AND_CONS_DEEPFAKE,
        question:
          'Do you think Deepfake technology should be regulated by your government?',
        multiAnswer: false,
        options: [
          {
            option: 'Yes',
      ...
      },
      {
        ...
        from: LearningMaterialType.PROS_AND_CONS_DEEPFAKE,
        question:
          'Where do you think Deepfake technology poses the biggest threat?',
        multiAnswer: false,
        options: [
          {
            option: 'Political',
